...
<body>
    ...
    <div class="course-banner-mobile practice-course">
        <img src="/assets/img/practice/banner.png" alt="">
    </div>
        ...
        <div class="content">
            <main class="container">
                <div class="about-course">
                    <h1 class="title">Практика на реальном пульте системы бронирования</h1>
                    <div class="about-course__info">
                        ...
                        <div class="about-course__link">
                            <img src="/assets/img/icons/practice2.svg" alt="Отправить запрос">
